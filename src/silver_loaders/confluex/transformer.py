...
source_schema = config["source_schema"]  # bronze_confluex

# ---------------------------------------------------------------------------
# 3a. CDC tables — APPLY CHANGES INTO (SCD Type 1)
# ---------------------------------------------------------------------------
def create_silver_cdc_table(table_meta):
    ...
    dlt.create_streaming_table(
        name=target_name,
        comment=f"Silver CDC streaming table for {target_name} — all sources unified",
...
# ---------------------------------------------------------------------------
# 3b. Non-CDC tables — standard DLT Streaming Table
# ---------------------------------------------------------------------------
